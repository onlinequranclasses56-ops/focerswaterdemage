...
const COMBO_CONTENT: Record<ComboKey, ComboContent> = {
  ...
  [key("storm-damage-restoration", "debary")]: {
    ...
    faqs: [
      { question: "What should I do immediately after storm damage to my DeBary home?", answer: "First ensure your household's safety — do not enter areas with structural instability, gas smells, or electrical hazards. Once safe, call Force1 Restoration at (864) 734-5702 for immediate emergency response. Document visible damage with your own photographs if safe to do so, but do not begin discarding damaged materials before our team has documented the loss for your insurance claim." },
  ...
  [key("storm-damage-restoration", "orange-city")]: {
    ...
    faqs: [
      ...
      { question: "My Orange City roof is leaking after a storm — what should I do?", answer: "Call Force1 Restoration at (864) 734-5702 immediately. While waiting for our team to arrive, place buckets to collect dripping water and move valuables away from the leak area. Do not go on the roof yourself to assess or tarp — our team handles emergency tarping safely. Stopping water intrusion as quickly as possible limits the extent of interior water and mold damage." },
  ...
  [key("fire-damage-restoration", "debary")]: {
    ...
    faqs: [
      { question: "What is the first step after a house fire in DeBary?", answer: "After the fire department clears the property as safe, call Force1 Restoration at (864) 734-5702 immediately. Do not enter a fire-damaged structure before it has been declared safe — compromised structural elements and electrical hazards are not always obvious. Force1 Restoration conducts a safety assessment before beginning any work and starts emergency board-up and tarping to prevent further damage and unauthorized entry." },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: titleStr,
    description: `Force1 Restoration provides ${service.name.toLowerCase()} in ${city.name}, FL. IICRC Certified · 24/7 Emergency · Licensed & Insured. Call (864) 734-5702.`,
