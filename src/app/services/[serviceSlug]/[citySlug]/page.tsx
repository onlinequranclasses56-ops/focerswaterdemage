...
const COMBO_CONTENT: Record<ComboKey, ComboContent> = {
  ...
  [key("water-damage-restoration", "debary")]: {
    ...
    bodyParagraphs: [
      ...
      "Forces Water Damage DeBary technicians calibrate drying equipment specifically for DeBary's ambient conditions. Psychrometric calculations account for the area's elevated baseline relative humidity, and equipment placement is optimized to achieve IICRC S500 dry standard within an efficient timeframe despite challenging environmental conditions.",
      "Common water damage scenarios in DeBary include: roof intrusion from tropical system rainfall, St. Johns River backflow flooding during named storms, supply line failures in older homes throughout the Saxon Boulevard and Highbanks Road corridors, and washing machine or dishwasher failures. Forces Water Damage DeBary responds to all of these with the same urgency and professionalism — a live team member answers every call, 24 hours a day.",
      "Insurance documentation is critical for DeBary homeowners dealing with flood-related events, as the distinction between covered sudden water damage and flood damage (which requires separate NFIP flood insurance) often matters in the claims process. Forces Water Damage DeBary provides detailed photographic and written documentation of every loss, including moisture readings and affected area diagrams, to support your claim with your carrier.",
    ],
    localFactors: [
  ...
  [key("water-damage-restoration", "orange-city")]: {
    ...
    localFactors: [
      ...
      { title: "Same rapid response", desc: "Forces Water Damage DeBary's DeBary base provides fast emergency response throughout Orange City — we answer 24/7 and dispatch immediately." },
    ],
    faqs: [
      { question: "How fast can Forces Water Damage DeBary reach Orange City for water damage?", answer: "Forces Water Damage DeBary is based in neighboring DeBary and provides rapid emergency response to Orange City 24 hours a day, 7 days a week. For water damage emergencies, every minute of delay increases the risk of structural damage and mold growth — call (864) 734-5702 immediately after discovering water damage." },
      { question: "Does Forces Water Damage DeBary handle commercial water damage in Orange City?", answer: "Yes. Forces Water Damage DeBary handles commercial water damage for businesses, retail spaces, medical offices, and multi-tenant properties throughout Orange City. Commercial jobs often require coordination with building management, after-hours scheduling, and more complex insurance documentation — our team is experienced in all of these." },
      { question: "What causes the most common water damage in Orange City homes?", answer: "The most common sources in Orange City's residential areas are supply line failures (especially in older homes with galvanized plumbing), water heater failures, roof intrusion from Florida's heavy summer thunderstorms, and AC drain pan overflow. Forces Water Damage DeBary responds to all of these events with the same urgency and IICRC-certified extraction process." },
      { question: "Will water damage to my Orange City home lead to mold?", answer: "Without prompt extraction and professional drying, yes — mold can begin growing within 24 to 48 hours in Florida's warm climate. Forces Water Damage DeBary's process is specifically designed to prevent mold colonization by achieving IICRC S500 dry standard within the critical window after a water event." },
    ],
  },
  ...
  [key("mold-remediation", "orange-city")]: {
    ...
    bodyParagraphs: [
      ...
      "Multi-family and commercial properties in Orange City face additional mold challenges: shared HVAC systems can distribute spores between units, building managers may not discover mold in individual units until it becomes extensive, and commercial building codes may require specific documentation before reopening after remediation. Forces Water Damage DeBary is experienced in commercial mold remediation and the associated documentation requirements.",
      "Orange City's commercial corridor includes properties that may have deferred maintenance or older HVAC systems that are known contributors to mold growth. AC evaporator coils that are not regularly cleaned accumulate debris and moisture, and the condensate pan can overflow — introducing water into wall cavities and subfloor systems. Forces Water Damage DeBary's mold remediation process always identifies and addresses the moisture source before removal begins.",
      "For Orange City homeowners discovering mold after a water event, the priority is acting quickly. Every day mold grows unchecked, it spreads to additional surfaces and embeds more deeply into porous materials — increasing the scope of remediation required. Forces Water Damage DeBary provides rapid response for both emergency and scheduled mold inspections in Orange City, FL.",
    ],
    localFactors: [
      ...
      { title: "Rapid response", desc: "Forces Water Damage DeBary responds quickly from our DeBary base to mold inspections and emergency remediation in Orange City, FL." },
    ],
    faqs: [
  ...
  [key("fire-damage-restoration", "debary")]: {
    ...
    localFactors: [
      ...
      { title: "Immediate local response", desc: "Forces Water Damage DeBary's DeBary base enables the fastest post-fire response in the area — beginning mitigation as soon as the fire department clears the property." },
    ],
    faqs: [
      { question: "What is the first step after a house fire in DeBary?", answer: "After the fire department clears the property as safe, call Forces Water Damage DeBary at (864) 734-5702 immediately. Do not enter a fire-damaged structure before it has been declared safe — compromised structural elements and electrical hazards are not always obvious. Forces Water Damage DeBary conducts a safety assessment before beginning any work and starts emergency board-up and tarping to prevent further damage and unauthorized entry." },
      ...
      { question: "Does Forces Water Damage DeBary handle lightning-caused fire damage in DeBary?", answer: "Yes. Lightning-caused fires are among the most common fire damage events in DeBary, particularly in attic spaces where lightning contacts wood-framed rooflines. Forces Water Damage DeBary responds to these events with the same urgency and IICRC S700-compliant process as any other fire damage call — assessing structural safety, beginning emergency securing, and then addressing soot, smoke, and water damage." },
      { question: "Can Forces Water Damage DeBary salvage belongings damaged by fire and smoke in DeBary?", answer: "Many contents can be professionally cleaned after fire and smoke damage if addressed promptly. Forces Water Damage DeBary assesses contents during the early phases of restoration and applies appropriate cleaning techniques for different material types. Items that cannot be cleaned to an acceptable standard are documented thoroughly for your insurance claim." },
    ],
  },
  ...
  [key("fire-damage-restoration", "orange-city")]: {
    ...
    answerFirst:
      "Fire damage restoration in Orange City, FL addresses the complex combination of structural fire damage, smoke and soot contamination, firefighting water damage, and persistent odor problems that follow residential and commercial fires. Forces Water Damage DeBary serves Orange City from our Volusia County base, providing rapid emergency response and comprehensive IICRC S700-certified fire and smoke restoration for both residential and commercial properties.",
    bodyParagraphs: [
    ...
    localFactors: [
      ...
      { title: "Older building materials", desc: "Some of Orange City's older commercial structures may contain materials that require special handling after fire — Forces Water Damage DeBary assesses for these as part of every safety evaluation." },
      { title: "Rapid response", desc: "Forces Water Damage DeBary responds to fire damage in Orange City from our DeBary base — available 24/7 and dispatching immediately after the fire department clears the property." },
    ],
    faqs: [
      { question: "Does Forces Water Damage DeBary handle commercial fire damage in Orange City?", answer: "Yes. Forces Water Damage DeBary provides commercial fire damage restoration for retail spaces, office buildings, restaurants, medical facilities, and other commercial properties in Orange City. Commercial fire restoration involves specific safety assessments, coordination with building owners and tenants, commercial insurance documentation, and restoration approaches that account for the distinct construction and occupancy of commercial buildings." },
      { question: "How quickly does Forces Water Damage DeBary respond to fire damage in Orange City?", answer: "Forces Water Damage DeBary answers calls 24 hours a day and dispatches immediately after your call. Once the fire department clears the property as safe, our team can begin emergency board-up, tarping, and the initial assessment. For fire damage, speed matters — soot begins permanently etching and staining surfaces within hours, and the window for effective cleaning narrows the longer it sits." },
      { question: "Will my homeowners insurance cover fire damage in Orange City?", answer: "Fire is a standard covered peril in most homeowners insurance policies. This typically covers both structural damage and personal property (contents). Forces Water Damage DeBary provides comprehensive documentation from the moment we arrive — photos, moisture readings, scope of damage — and can work directly with your insurance adjuster throughout the restoration process." },
      { question: "What does professional smoke odor elimination involve in Orange City?", answer: "Professional smoke odor elimination goes beyond surface cleaning to treat the porous materials that absorb smoke particles — insulation, drywall, framing, soft goods, and even HVAC ductwork. Forces Water Damage DeBary uses thermal fogging (which mimics smoke behavior to reach embedded odors), hydroxyl generators, and ozone treatment in appropriate settings to neutralize odors at the molecular level, not just mask them." },
    ],
  },
};
...
export default async function ComboPage({ params }: Props) {
  ...
  return (
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-primary-50 border border-primary/20 rounded-2xl p-6 md:p-8">
            <h2 id="combo-answer" className="text-xl font-bold text-ink mb-3">
              {service.name} in {city.name}: What to Expect from Forces Water Damage DeBary
            </h2>
      ...
      <CTASection
        headline={`Forces Water Damage DeBary provides ${service.name} in ${city.name}, FL`}
