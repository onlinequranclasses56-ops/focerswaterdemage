...
export const metadata: Metadata = {
  title: "FAQ — Water Damage & Restoration Questions | Force1 Restoration",
  description:
    "Common questions about water damage restoration, mold remediation, storm damage, fire damage, and the restoration process — answered by Force1 Restoration serving DeBary and Orange City, FL.",
...
const ALL_FAQS = [
  ...
  /* Insurance */
  { question: "Does Force1 Restoration work with insurance companies?", answer: "Yes. Force1 Restoration works alongside most major insurance carriers. We provide comprehensive documentation from the first day on-site — photographs, moisture readings, written scope — that your adjuster needs to process your claim. We recommend calling us first so mitigation begins immediately; you can notify your insurer while we work." },
  { question: "Will filing a restoration claim raise my insurance rates?", answer: "That depends on your specific policy, carrier, and claim history. Typically, a single claim does not automatically raise rates. Force1 Restoration's documentation ensures that the full scope of covered damage is captured, which is in your interest regardless of the rate impact question." },
] as const;
  ...
  return (
    <>
      ...
      <Hero
        ...
        subheadline="Common questions about water damage, mold, storm damage, fire damage, and the restoration process — answered by Force1 Restoration."
